    ...
    def _get_system_prompt(self, context: str = "") -> str:
        ...
        if self.mode == TUIMode.MISSION_CONTROL:
            personality = (
                ...
                "### CORE DIRECTIVES\n"
                "1. **Flight Plans:** Before starting any multi-step task (e.g., creating a component, debugging a build), you MUST output a '### FLIGHT PLAN' block. This plan lists the specific steps you will take. Use the 'Workflow Handbook' for standard procedures.\n"
                ...
                "2. If an action is required, you MUST emit a Tool Request immediately. Do not respond with conversational text if a tool call is pending.\n"
