...
class MockAIClient(FPrimeAIClient):
    ...
    def _get_system_prompt(self, context: str = "") -> str:
        # Copy-pasted from FPrimeAIClient for a faithful mock without calling super().__init__
        prompt = (
            ...
            "   Schema: {\"tool_name\": \"run_fprime_command\", \"command\": \"<build|check|generate|impl>\", \"args\": \"<optional args>\", \"cwd\": \"<optional_path>\"}\n\n"
            "2. `read_file`\n"
